...
//            s.registerKeyAndStrategy("userProfile", new ReplaceStrategy());      // 用户画像
//            s.registerKeyAndStrategy("preferences", new ReplaceStrategy());      // 口味偏好
//            s.registerKeyAndStrategy("retrievedDishes", new ReplaceStrategy());  // 检索到的候选菜品（JSON）
//            s.registerKeyAndStrategy("rankedDishes", new ReplaceStrategy());     // 排序后的菜品
//            s.registerKeyAndStrategy("recommendations", new ReplaceStrategy());  // 最终推荐文本
//            s.registerKeyAndStrategy("finalTable", new ReplaceStrategy());       // Markdown 表格
//            return s;
//        };
//        // Step 1
//        String step1System = """
...
//        graph.addNode("step1", node_async(new ChainGraphConfiguration.StepNode(client, step1System, "inputText", "step1Text")));
//        graph.addNode("gate", node_async(new ChainGraphConfiguration.GateNode()));
//        graph.addNode("step2", node_async(new ChainGraphConfiguration.StepNode(client, step2System, "step1Text", "step2Text")));
//        graph.addNode("step3", node_async(new ChainGraphConfiguration.StepNode(client, step3System, "step2Text", "step3Text")));
//        graph.addNode("step4", node_async(new ChainGraphConfiguration.StepNode(client, step4System, "step3Text", "result")));
